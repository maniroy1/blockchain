...
import com.moglix.reports.fabric.sdkintegration.SampleOrg;
...
//                    DEFAULT_CONFIG));
            ...
            for (Map.Entry<String, SampleOrg> org : sampleOrgs.entrySet()) {
                ...
                if (runningFabricCATLS) {
                    String cert = "src/main/java/com/moglix/reports/fixture/sdkintegration/e2e/channel/crypto-config/peerOrganizations/DNAME/ca/ca.DNAME-cert.pem".replaceAll("DNAME", domainName);
    ...
    public String getTestChannelPath() {
        ...
        return "src/main/java/com/moglix/reports/fixture/sdkintegration/e2e/channel";
